module adder16 (carry,
 ...
 sky130_fd_sc_hd__nor2_1 _157_ (.A(_123_),
    ...
    .VPWR(VPWR),
    .Y(_125_));
 sky130_fd_sc_hd__and2_1 _158_ (.A(net13),
    .B(net29),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _160_ (.A(_126_),
    ...
    .VPWR(VPWR),
    .Y(_128_));
 sky130_fd_sc_hd__nor4_1 _161_ (.A(_123_),
    .B(_124_),
    .C(_126_),
    .D(_127_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _168_ (.A(net12),
    ...
    .VPWR(VPWR),
    .Y(_020_));
 sky130_fd_sc_hd__a211oi_1 _169_ (.A1(_131_),
    .A2(_132_),
    .B1(_018_),
    .C1(_020_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__or2_1 _183_ (.A(_031_),
    ...
    .VPWR(VPWR),
    .X(_035_));
 sky130_fd_sc_hd__nor4_1 _184_ (.A(_028_),
    .B(_029_),
    .C(_031_),
    .D(_033_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o211a_1 _193_ (.A1(net3),
    ...
    .VPWR(VPWR),
    .X(_045_));
 sky130_fd_sc_hd__a211o_1 _194_ (.A1(_036_),
    .A2(_044_),
    .B1(_045_),
    .C1(_028_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _204_ (.A1(net5),
    ...
    .VPWR(VPWR),
    .Y(_056_));
 sky130_fd_sc_hd__a22oi_1 _205_ (.A1(_107_),
    .A2(_109_),
    .B1(_054_),
    .B2(_056_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__buf_1 input7 (.A(a[15]),
    ...
    .VPWR(VPWR),
    .X(net7));
 sky130_fd_sc_hd__clkbuf_2 input8 (.A(a[1]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
