module adder16 (carry,
 ...
 sky130_fd_sc_hd__nor2_1 _135_ (.A(net14),
    ...
    .VPWR(VPWR),
    .Y(_103_));
 sky130_fd_sc_hd__xnor2_1 _136_ (.A(net14),
    .B(net30),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _137_ (.A(net13),
    ...
    .VPWR(VPWR),
    .Y(_105_));
 sky130_fd_sc_hd__xnor2_1 _138_ (.A(net13),
    .B(net29),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_106_));
 sky130_fd_sc_hd__or2_1 _139_ (.A(_104_),
    .B(_106_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _145_ (.A(_111_),
    ...
    .VPWR(VPWR),
    .Y(_018_));
 sky130_fd_sc_hd__or3_1 _146_ (.A(_107_),
    .B(_110_),
    .C(_018_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _165_ (.A(_036_),
    ...
    .VPWR(VPWR),
    .Y(_038_));
 sky130_fd_sc_hd__a2111o_1 _166_ (.A1(_020_),
    .A2(_022_),
    .B1(_032_),
    .C1(_035_),
    .D1(_038_),
 ...
 sky130_fd_sc_hd__o221a_1 _168_ (.A1(_025_),
    ...
    .VPWR(VPWR),
    .X(_041_));
 sky130_fd_sc_hd__nand2_1 _169_ (.A(_039_),
    .B(_041_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_042_));
 sky130_fd_sc_hd__a21bo_1 _170_ (.A1(_039_),
    .A2(_041_),
    .B1_N(_090_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a31o_1 _173_ (.A1(_088_),
    ...
    .VPWR(VPWR),
    .X(_046_));
 sky130_fd_sc_hd__a311o_1 _174_ (.A1(_088_),
    .A2(_043_),
    .A3(_044_),
    .B1(_087_),
    .C1(_086_),
    ...
    .VPWR(VPWR),
    .X(_047_));
 sky130_fd_sc_hd__a21o_1 _175_ (.A1(_084_),
    .A2(_047_),
    .B1(_083_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__xor2_1 _178_ (.A(net1),
    ...
    .VPWR(VPWR),
    .X(_050_));
 sky130_fd_sc_hd__mux2_1 _179_ (.A0(net36),
    .A1(_050_),
    .S(net55),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__xnor2_1 _193_ (.A(_110_),
    ...
    .VPWR(VPWR),
    .Y(_060_));
 sky130_fd_sc_hd__mux2_1 _194_ (.A0(net47),
    .A1(_060_),
    .S(net54),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21a_1 _195_ (.A1(_108_),
    ...
    .VPWR(VPWR),
    .X(_061_));
 sky130_fd_sc_hd__xor2_1 _196_ (.A(_106_),
    .B(_061_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_062_));
 sky130_fd_sc_hd__mux2_1 _197_ (.A0(net48),
    .A1(_062_),
    .S(net54),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_007_));
 sky130_fd_sc_hd__o21ai_1 _198_ (.A1(_106_),
    .A2(_061_),
    .B1(_105_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__xnor2_1 _199_ (.A(_104_),
    ...
    .VPWR(VPWR),
    .Y(_064_));
 sky130_fd_sc_hd__mux2_1 _200_ (.A0(net49),
    .A1(_064_),
    .S(net54),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__xor2_1 _201_ (.A(_023_),
    ...
    .VPWR(VPWR),
    .X(_065_));
 sky130_fd_sc_hd__mux2_1 _202_ (.A0(net50),
    .A1(_065_),
    .S(net54),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__xnor2_1 _204_ (.A(_035_),
    ...
    .VPWR(VPWR),
    .Y(_067_));
 sky130_fd_sc_hd__mux2_1 _205_ (.A0(net51),
    .A1(_067_),
    .S(net54),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__xor2_1 _208_ (.A(_031_),
    ...
    .VPWR(VPWR),
    .X(_070_));
 sky130_fd_sc_hd__mux2_1 _209_ (.A0(net37),
    .A1(_070_),
    .S(net55),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_011_));
 sky130_fd_sc_hd__o31ai_1 _210_ (.A1(_030_),
    .A2(_033_),
    .A3(_068_),
    .B1(_029_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__xnor2_1 _211_ (.A(_027_),
    ...
    .VPWR(VPWR),
    .Y(_072_));
 sky130_fd_sc_hd__mux2_1 _212_ (.A0(net38),
    .A1(_072_),
    .S(net55),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__xor2_1 _213_ (.A(_090_),
    ...
    .VPWR(VPWR),
    .X(_073_));
 sky130_fd_sc_hd__mux2_1 _214_ (.A0(net39),
    .A1(_073_),
    .S(net55),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a31o_1 _216_ (.A1(_088_),
    ...
    .VPWR(VPWR),
    .X(_075_));
 sky130_fd_sc_hd__a2bb2o_1 _217_ (.A1_N(_075_),
    .A2_N(_074_),
    .B1(net40),
    .B2(_080_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_7_54 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_7_55 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_8_56 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_8_57 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_9_58 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_9_59 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_10_60 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_10_61 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_11_62 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_11_63 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_12_64 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_12_65 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_13_66 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_13_67 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_14_68 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_14_69 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_15_70 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_15_71 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_16_72 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_16_73 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_17_74 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_17_75 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_18_76 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_18_77 (.VGND(VGND),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__clkbuf_1 input33 (.A(en),
    ...
    .VPWR(VPWR),
    .X(net33));
 sky130_fd_sc_hd__clkbuf_1 input34 (.A(rst_n),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
